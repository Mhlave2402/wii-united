...
use Modules\VehicleManagement\Http\Controllers\FleetVehicleController;
...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => 'admin'], function () {
    Route::group(['prefix' => 'vehicle', 'as' => 'vehicle.'], function () {
        ...
        Route::resource('fleet-vehicles', FleetVehicleController::class); // Added FleetVehicle routes
    });
});
